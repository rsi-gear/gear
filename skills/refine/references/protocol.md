...
Runtime stages (`load`, `skillDiscovery`, `skillRead`, `cleanup`) distinguish
...
disposable snapshot and reads Skills through the native tool. Its missing or
invalid report is a failure, even with a zero process exit code. Failures
