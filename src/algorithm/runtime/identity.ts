...
const files = ['contracts', 'schema', 'artifacts', 'bindings', 'steps', 'provider-errors', 'runtime/engine', 'runtime/store', 'runtime/persistence', 'runtime/providers', 'runtime/identity'];
