// Frozen behavioral oracle from ec76b8b25703c46cbe3b2aaf94b64dc0c2277921:src/search/engine.ts
// Original SHA256: ccb837ed2ebc85afcb6b63ea0f7acf0f28fdae6251fde7401e11c9da3ce7f732
// Only relative imports and the exported class name are relocated. Do not edit policy behavior.
import { searchProtocolVersion } from '../../src/search/identity.js'
import { ComponentRegistry } from '../../src/evolution/components.js'
import { digestJson } from '../../src/state/digest.js'
import { buildArchive, passesExploration } from '../../src/search/archive.js'
import type { EvidenceCompletion } from '../../src/search/completion.js'
import { integrity, invariant, numeric, plannedCellCount, resolveSizing, safeId, scopeEquivalenceDigest, seal, sorted, utility } from '../../src/search/contracts.js'
import { clusters } from '../../src/search/diagnosis.js'
import { prepareScopeEpochs, scopeEpoch, type ScopeEpochPreparation } from '../../src/search/epochs.js'
import { profile, validOutcome } from '../../src/search/evidence.js'
import { objectiveProfile, scoringComplete, scoringValue } from '../../src/search/objective.js'
import type { ObjectiveBaseline } from '../../src/objective/scoring.js'
import { parentSelectionInput, selectParentsWithPolicy } from '../../src/search/parent-selection.js'
import { resolveParentPolicyRef } from '../../src/search/policies/parents.js'
import type { PromotionInput } from '../../src/search/promotion.js'
import { assessGate, decideFinal, precheckSeed, rankProfiles } from '../../src/search/promotion.js'
import { searchDeadline } from '../../src/search/recovery.js'
import type { RegressionProposal } from '../../src/search/regression.js'
import { collectFailure, sanitizedRegressionPrompt } from '../../src/search/regression.js'
import { SearchExecutionRuntime, type GeneratedCandidate, type PreparedWork, type SearchAdmission, type SearchExecutionHooks } from '../../src/search/runtime.js'
import { validateSearchSchema } from '../../src/search/schema.js'
import { samplingEvidence } from '../../src/search/scope-sampling.js'
import { bridgeSelection, createScope, stagePlan } from '../../src/search/scopes.js'
import type { RemainingBudget } from '../../src/search/store.js'
import { SearchBudgetExceeded, type SearchJournal } from '../../src/search/store.js'
import type { BridgeSelectionDecision, CandidateWorkPlan, DiagnosisDossier, DiagnosisProvider, EvaluationScope, EvaluationStageDecision, GateDecision, ParentSelectionDecision, ResearchArchive, ResearchFinding, SearchProvider, Snapshot, StageEvaluationPlan, StageResult, TaskUniverse } from '../../src/search/types.js'
export type { GeneratedCandidate, SearchAdmission, SearchExecutionHooks } from '../../src/search/runtime.js'
...
export interface SearchEvolutionIdentity {
  ...
  parentPolicy?: import('../../src/types.js').ComponentRef<unknown>
  digest: string
}
...
export class FrozenFailureClusterSearch {
  ...
  async run(request: SearchAdmission, signal: AbortSignal): Promise<SearchRoundOutcome> {
    ...
    if (saved) {
      const previous = await this.store.object<SearchAdmission & { algorithmIntegrity: string; parentPolicyRef?: import('../../src/types.js').ComponentRef<unknown>; digest: string }>(saved.ref)
    ...
    const planning = await this.store.freeze(request.roundId, 'planning', async () => {
      ...
      const diagnosedClusters: import('../../src/search/types.js').FailureCluster[] = []
